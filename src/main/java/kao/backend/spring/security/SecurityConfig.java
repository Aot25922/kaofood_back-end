...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost","https://kaofood.works","https://www.kaofood.works","https://kaofood.netlify.app","https://192.168.1.102"));
